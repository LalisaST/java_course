...
public class SolverBFSTest {
    ...
    void enteringInvalidValuesSolve(Maze maze, Point start, Point end) {
        ...
        assertThatThrownBy(() -> solverBFS.solve(maze, start, end)).isInstanceOf(
    ...
    void solverDoesntFindPath() {
        ...
        assertThat(solverBFS.solve(maze, new Point(1, 1), new Point(5, 5))).isEqualTo(Collections.emptyList());
    }
    ...
    void solverFindPath() {
        ...
        List<Point> solverTest = solverBFS.solve(maze, new Point(1, 1), new Point(5, 5));
                List<Point> prescribedSolver = List.of(new Point(5, 5),
            new Point(5, 4),
            new Point(5, 3),
            new Point(5, 2),
            new Point(5, 1),

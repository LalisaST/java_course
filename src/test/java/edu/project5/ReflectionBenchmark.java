...
public class ReflectionBenchmark {
    ...
    private Function<Student, String> invokerLambda;
    ...
    public void setup()
        ...
        invokerLambda = (Function<Student, String>) callSite.getTarget().invokeExact();
    }
    ...
    public void lambdaMetafactory(Blackhole bh) {
        String name = invokerLambda.apply(student);
        bh.consume(name);
    }
}
